...
<link rel="shortcut icon"
	href="<c:url value='/static/img/favicon.png' />" />
...
<link
	...
	rel="stylesheet" />
<link
	href="<c:url value='/static/assets/jquery-easy-pie-chart/jquery.easy-pie-chart.css' />"
	rel="stylesheet" type="text/css" media="screen" />
<link rel="stylesheet"
	href="<c:url value='/static/css/owl.carousel.css' />" type="text/css">
...
<body class="mega-nav">
							...
							<div class="panel-body">
									...
									<div class="col-lg-4">
										...
										<div class="panel terques-chart">
											...
											<div class="chart-tittle">
												<span class="title">New Earning</span> <span class="value">
													<a href="#" class="active">Market</a> | <a href="#">Referal</a>
													| <a href="#">Online</a>
												</span>
											</div>
										</div>
								...
								<div class="row">
									<div class="col-lg-4">
										...
										<section class="panel">
											<div class="panel-body">
												<a href="#" class="task-thumb"> <img
													src="<c:url value='/static/img/avatar1.jpg' />" alt="">
												</a>
															...
															<div class="panel">
																<div class="panel-body">
																	<span class="arrow"></span> <span
																		class="timeline-icon red"></span> <span
																		class="timeline-date">08:25 am</span>
														...
														<div class="timeline-desk">
															<div class="panel">
																<div class="panel-body">
																	...
																	<p>
																		<a href="#">Jonathan Smith</a> added new milestone <span><a
																			href="#" class="green">ERP</a></span>
																	</p>
																</div>
															</div>
														</div>
														...
														<div class="timeline-desk">
															<div class="panel">
																<div class="panel-body">
																	...
																	<p>
																		<a href="#">Anjelina Joli</a> added new album <span><a
																			href="#" class="blue">PARTY TIME</a></span>
																	</p>
																	<div class="album">
																		<a href="#"> <img alt=""
																			src="<c:url value='/static/img/sm-img-1.jpg' />">
																		</a> <a href="#"> <img alt=""
																			src="<c:url value='/static/img/sm-img-2.jpg' />">
																		</a> <a href="#"> <img alt=""
																			src="<c:url value='/static/img/sm-img-3.jpg' />">
																		</a> <a href="#"> <img alt=""
																			src="<c:url value='/static/img/sm-img-1.jpg' />">
																		</a> <a href="#"> <img alt=""
																			src="<c:url value='/static/img/sm-img-2.jpg' />">
															...
															<div class="panel">
																<div class="panel-body">
																	...
																	<div class="notification">
																		<i class=" fa fa-exclamation-sign"></i> New task added
																		for <a href="#">Denial Collins</a>
																	</div>
																</div>
															</div>
														</div>
														...
														<div class="timeline-desk">
															<div class="panel">
																<div class="panel-body">
																	...
																	<p>
																		<a href="#">Jonatha Smith</a> added new milestone <span><a
																			href="#" class="light-green">prank</a></span> Lorem ipsum
																		dolor sit amet consiquest dio
																	</p>
																</div>
															</div>
														</div>
												...
												<div class="row">
													...
													<div class="col-lg-6 col-sm-6">
														<div class="chart-info chart-position">
															<span class="increase"></span> <span>Revenue
																Increase</span>
														</div>
														<div class="chart-info">
															<span class="decrease"></span> <span>Revenue
																Decrease</span>
														</div>
													</div>
												</div>
											...
											<div class="panel-footer revenue-foot">
												<ul>
													...
													<li><a href="javascript:;"> <i
															class=" fa fa-th-large"></i> Tabular
													</a></li>
										...
										<section class="panel">
											<div class="flat-carousal">
												<div id="owl-demo" class="owl-carousel owl-theme">
													<div class="item">
														<h1>Flatlab is new model of admin dashboard for happy
															use</h1>
											...
											<div class="panel-body">
												<ul class="ft-link">
													...
													<li><a href="javascript:;"> <i
															class=" fa fa-calendar-o"></i> promo
													</a></li>
													<li><a href="javascript:;"> <i
															class=" fa fa-camera"></i> photo
													</a></li>
													<li><a href="javascript:;"> <i
															class=" fa fa-circle"></i> other
													</a></li>
												</ul>
											</div>
										</section>
									...
									<div class="col-lg-8">
										...
										<section class="panel post-wrap pro-box">
											...
											<aside class="post-highlight yellow v-align">
												<div class="panel-body text-center">
													<div class="pro-thumb">
														<img src="<c:url value='/static/img/ring.jpg' />" alt="">
													</div>
												</div>
											</aside>
										</section>
										...
										<section class="panel post-wrap pro-box">
											<aside class="post-highlight terques v-align">
												<div class="panel-body">
													<h2>
														Flatlab is new model of admin dashboard <a
															href="javascript:;"> http://demo.com/</a> 4 days ago by
														jonathan smith
													</h2>
												</div>
											</aside>
													...
													<div class="follower">
														<div class="panel-body">
															...
															<div class="follow-ava">
																<img
																	src="<c:url value='/static/img/follower-avatar.jpg' />"
																	alt="">
															</div>
														</div>
													</div>
	...
	<script src="<c:url value='/static/js/jquery.sparkline.js' />"
		type="text/javascript"></script>
	<script
		src="<c:url value='/static/assets/jquery-easy-pie-chart/jquery.easy-pie-chart.js' />"></script>
	<script src="<c:url value='/static/js/owl.carousel.js' />"></script>
	<script src="<c:url value='/static/js/jquery.customSelect.min.js' />"></script>
	<script src="<c:url value='/static/js/respond.min.js' />"></script>
	...
	<script src="<c:url value='/static/js/sparkline-chart.js' />"></script>
	<script src="<c:url value='/static/js/easy-pie-chart.js' />"></script>
	<script src="<c:url value='/static/js/count.js' />"></script>
