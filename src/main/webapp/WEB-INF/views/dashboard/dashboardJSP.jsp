...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<c:url value='/static/css/owl.carousel.css' />" type="text/css">
  ...
  <section id="container">
                      ...
                      <section class="panel">
                          <div class="panel-body">
                              <a href="#" class="task-thumb">
                                  <img src="<c:url value='/static/img/avatar1.jpg' />" alt="">
                              </a>
                                          ...
                                          <div class="timeline-desk">
                                              <div class="panel">
                                                  <div class="panel-body">
                                                      ...
                                                      <div class="album">
                                                          <a href="#">
                                                              <img alt="" src="<c:url value='/static/img/sm-img-1.jpg' />">
                                                          </a>
                                                          <a href="#">
                                                              <img alt="" src="<c:url value='/static/img/sm-img-2.jpg' />">
                                                          </a>
                                                          <a href="#">
                                                              <img alt="" src="<c:url value='/static/img/sm-img-3.jpg' />">
                                                          </a>
                                                          <a href="#">
                                                              <img alt="" src="<c:url value='/static/img/sm-img-1.jpg' />">
                                                          </a>
                                  ...
                                  <div class="follower">
                                      <div class="panel-body">
                                          ...
                                          <div class="follow-ava">
                                              <img src="<c:url value='/static/img/follower-avatar.jpg' />" alt="">
                                          </div>
                                      </div>
                                  </div>
    ...
    <script src="<c:url value='/static/js/jquery.sparkline.js' />" type="text/javascript"></script>
