                            ...
                            <div class="panel-body">
                                ...
                                <form class="form-horizontal" id="default">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-5">
                                            <input id="accessories" name="accessories" type="text" placeholder="Accessories" class="form-control input-md">
                                        </div>
                                        <label class="col-md-1 " for="pkgDetails">Pkg. Details</label>
                                        <div class="col-md-3">
                                            <input id="pkgDetails" name="pkgDetails" type="text" placeholder="Pkg. Details" class="form-control input-md">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                     <label class="col-md-1 " for="ritcNo">RITC No</label>
                                        <div class="col-md-3">
                                            <input id="ritcNo" name="ritcNo" type="text" placeholder="RITC No" class="form-control input-md">
                                        </div>
                                        <label class="col-md-1 " for="amount">Scheme Code </label>
                                        <div class="col-md-3">
                                            <input id="schemeCode" name="schemeCode" type="text" placeholder="Scheme Code" class="form-control input-md">
                                        </div>
                                        <label class="col-md-1 " for="amount">Category, If NFEI</label>
                                        <div class="col-md-3">
                                    ...
                                    <label class="col-md-1 " for="amount">Invoice No </label>
                                        <div class="col-md-3">
                                            <input id="invoiceNo" name="invoiceNo" type="text" placeholder="Invoice No" class="form-control input-md">
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <input id="itemRate" name="itemRate" type="text" placeholder="Item Rate" class="form-control input-md">
                                        </div>
                                        <label class="col-md-1 " for="per">Per </label>
                                        <div class="col-md-3">
                                            <input id="per" name="per" type="text" placeholder="Per" class="form-control input-md">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <input id="pmv" name="pmv" type="text" placeholder="PMV" class="form-control input-md">
                                        </div>
                                        <label class="col-md-1 " for="pmvUnit">Unit </label>
                                        <div class="col-md-3">
                                            <input id="pmvUnit" name="pmvUnit" type="text" placeholder="Unit" class="form-control input-md">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <input id="netWeight" name="netWeight" type="text" placeholder="Net Weight" class="form-control input-md">
                                        </div>
                                        <label class="col-md-1 " for="perUnit">/Unit </label>
                                        <div class="col-md-3">
                                            <input id="perUnit" name="perUnit" type="text" placeholder="/ Unit" class="form-control input-md">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-1 " for="noOfPackages">No. Of Packages </label>
                                        <div class="col-md-5">
                                            <input id="noOfPackages" name="noOfPackages" type="text" placeholder="No. of Packages" class="form-control input-md">
                                        </div>
                                        <label class="col-md-1 " for="noOfPackPerUnit">/Unit </label>
                                        <div class="col-md-3">
                                            <input id="noOfPackPerUnit" name="noOfPackPerUnit" type="text" placeholder="/Unit" class="form-control input-md">
                                        </div>
                                    </div>
                                     <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <input id="dbkSrNo" name="dbkSrNo" type="text" placeholder="Drawback Sr.No" class="form-control input-md">
                                        </div>
                                        <label class="col-md-1 " for="onWt">On WT </label>
                                        <div class="col-md-3">
                                            <input id="onWt" name="onWt" type="text" placeholder="On WT" class="form-control input-md">
                                        </div>
                                       <label class="col-md-1 " for="dbkPerUnit">/Unit </label>
                                        <div class="col-md-3">
                                            <input id="dbkPerUnit" name="dbkPerUnit" type="text" placeholder="/Unit" class="form-control input-md">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-1 " for="onFOB">On FOB</label>
                                        <div class="col-md-3">
                                            <input id="onFOB" name="onFOB" type="text" placeholder="On FOB" class="form-control input-md">
                                        </div>
                                       <label class="col-md-1 " for="dbkQuantity">Drawback Quantity </label>
                                        <div class="col-md-3">
                                            <input id="dbkQuantity" name="dbkQuantity" type="text" placeholder="Drawback Quantity" class="form-control input-md">
                                        </div>
                                        <label class="col-md-1 " for="dbkQtyPerUnit">/Unit </label>
                                        <div class="col-md-3">
                                            <input id="dbkQtyPerUnit" name="dbkQtyPerUnit" type="text" placeholder="/Unit" class="form-control input-md">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-1 " for="stateFOB">State FOB %</label>
                                        <div class="col-md-3">
                                            <input id="stateFOB" name="stateFOB" type="text" placeholder="State FOB %" class="form-control input-md">
                                        </div>
                                       <label class="col-md-1 " for="statePerQty">/ Quantity</label>
                                        <div class="col-md-3">
                                            <input id="statePerQty" name="statePerQty" type="text" placeholder="/ Quantity" class="form-control input-md">
                                        </div>
                                        <label class="col-md-1 " for="stateWt">State FOB % on WT </label>
                                        <div class="col-md-3">
                                            <input id="stateWt" name="stateWt" type="text" placeholder="State FOB % on WT " class="form-control input-md">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-1 " for="stateAmt">State Amount</label>
                                        <div class="col-md-5">
                                            <input id="stateAmt" name="stateAmt" type="text" placeholder="State Amount" class="form-control input-md">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                              <input id="jobNotificationNo" name="jobNotificationNo" type="text" placeholder="Job Notification No." class="form-control input-md">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-1 " for="itemCodeStr">Item Code as Per Str Directory</label>
                                        <div class="col-md-3">
                                            <input id="itemCodeStr" name="itemCodeStr" type="text" placeholder="Item Code as Per Str Directory" class="form-control input-md">
                                        </div>
                                       <label class="col-md-1 " for="itemCodeReward">Item Code as Per Reward Directory (MEIS)</label>
                                        <div class="col-md-3">
                                            <input id="itemCodeReward" name="itemCodeReward" type="text" placeholder="Item Code as Per Reward Directory (MEIS)" class="form-control input-md">
                                        </div>
                                        <label class="col-md-1 " for="stateWt">State FOB % on WT </label>
                                        <div class="col-md-3">
                                            <input id="stateWt" name="stateWt" type="text" placeholder="State FOB % on WT " class="form-control input-md">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <input id="endUse" name="endUse" type="text" placeholder="End Use" class="form-control input-md">
                                        </div>
                                       <label class="col-md-1 " for="accessoryState">Accessory Status</label>
                                        <div class="col-md-3">
                                            <input id="accessoryState" name="accessoryState" type="text" placeholder="Accessory Status" class="form-control input-md">
                                        </div>
                                        <label class="col-md-1 " for="hawbNo">HAWB No </label>
                                        <div class="col-md-3">
                                            <input id="hawbNo" name="hawbNo" type="text" placeholder="HAWB No" class="form-control input-md">
                                        </div>
                                    </div>
                                     <div class="form-group">
                                        <label class="col-md-1 " for="totalPackage">Total Package</label>
                                        <div class="col-md-3">
                                            <input id="totalPackage" name="totalPackage" type="text" placeholder="Total Package" class="form-control input-md">
                                        </div>
                                       <label class="col-md-1 " for="igstPaymentStatus">IGST Payment Status</label>
                                        <div class="col-md-3">
                                            <input id="igstPaymentStatus" name="igstPaymentStatus" type="text" placeholder="IGST Payment Status" class="form-control input-md">
                                        </div>
                                        <label class="col-md-1 " for="taxableValue">Taxable Value </label>
                                        <div class="col-md-3">
                                            <input id="taxableValue" name="taxableValue" type="text" placeholder="Taxable Value" class="form-control input-md">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-1 " for="igstAmount">IGST Amount</label>
                                        <div class="col-md-3">
                                            <input id="igstAmount" name="igstAmount" type="text" placeholder="IGST Amount" class="form-control input-md">
                                        </div>
                                        <label class="col-md-1 " for=productDetails>Product Details </label>
                                        <div class="col-md-5">
                                             <textarea class="form-control custom-control" rows="1" name="productDetails"  id = "productDetails" style="height:80px"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <fieldset title="Additional Details" class="step" id="default-step-2">
                                        <legend> </legend>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <input id="consignee" name="consignee" type="text" placeholder="Consignee" class="form-control input-md">
                                            </div>
                                            <label class="col-md-1 " for="consigneeAddress">Address (*)</label>
                                            <div class="col-md-7">
                                                <input id="consigneeAddress" name="consigneeAddress" type="text" placeholder="Address" class="form-control input-md">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <div class="checkboxes">
                                                    <input name="consigneeBuyerSame" id="consigneeBuyerSame" value="1" type="checkbox" />                                                    Is Consignee & Buyer Same?
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <input id="buyer" name="buyer" type="text" placeholder="Buyer" class="form-control input-md">
                                            </div>
                                            <label class="col-md-1 " for="buyerAddress">Address (*)</label>
                                            <div class="col-md-7">
                                                <input id="buyerAddress" name="buyerAddress" type="text" placeholder="Address" class="form-control input-md">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-1 " for="buyerCountry">Country (*)</label>
                                            <div class="col-md-7">
                                                <input id="buyerCountry" name="buyerCountry" type="text" placeholder="Country" class="form-control input-md">
                                            </div>
                                            <label class="col-md-1 label_check" for="pmvRequired">(*) Shall itemwise PMV required?</label>
                                            <div class="col-md-3">
                                                <div class="checkboxes">
                                                    <input name="pmvRequired" id="pmvRequired" value="1" type="checkbox" />                                                    Shall itemwise PMV required?
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-7">
                                                <input id="productHead" name="productHead" type="text" placeholder="Product Head" class="form-control input-md">
                                            </div>
                                ...
                                <div class="col-md-8">
                                    ...
                                    <fieldset title="Doc And Agency Details" class="step" id="default-step-1">
                                        <legend> </legend>

                                        <div class="form-group">
                                            <label class="col-md-1 " for="accountPartyName">Account/Party Name (*)</label>
                                            <div class="col-md-3">
                                                <input id="accountPartyName" name="accountPartyName" type="text" placeholder="Account/Party Name" class="form-control input-md">
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                <input id="Organization" name="organization" type="text" placeholder="Organization" class="form-control input-md">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-1 " for="partyAddress">Address (*)</label>
                                            <div class="col-md-7">
                                                <input id="partyAddress" name="partyAddress" type="text" placeholder="partyAddress" class="form-control input-md">
                                            </div>
                                            <label class="col-md-1 " for="grBank">GR Bank </label>
                                            <div class="col-md-3">
                                                <input id="grBank" name="grBank" type="text" placeholder="GR Bank" class="form-control input-md">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-7">
                                                <input id="stateOfOriginOfGoods" name="stateOfOriginOfGoods" type="text" placeholder="State of Origin of Goods" class="form-control input-md">
                                            </div>
                                            <label class="col-md-1 " for="branchNo">Branch No</label>
                                            <div class="col-md-1">
                                                <input id="branchNo" name="branchNo" type="text" placeholder="Branch No" class="form-control input-md">
                                            </div>
                                            <label class="col-md-1 " for="itemCode">Item code as per Reward Directory (MEIS)</label>
                                            <div class="col-md-1">
                                                <input id="itemCode" name="itemCode" type="text" placeholder="Item Code" class="form-control input-md">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <input id="iecCodeNo" name="iecCodeNo" type="text" placeholder="IEC Code No" class="form-control input-md">
                                            </div>
                                            <label class="col-md-1 " for="panNo">PAN No</label>
                                            <div class="col-md-3">
                                                <input id="panNo" name="panNo" type="text" placeholder="PAN No" class="form-control input-md">
                                            </div>
                                    ...
                                    <div class="col-md-3"> 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <input id="exporterClass" name="exporterClass" type="text" placeholder="Exporter Class" class="form-control input-md">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <input id="natureOfPayment" name="natureOfPayment" type="text" placeholder="Nature Of Payment" class="form-control input-md">
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                <input id="periodPfPaymentInDays" name="periodPfPaymentInDays" type="text" placeholder="Period Of Payment In Days" class="form-control input-md">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <input id="exportContactNo" name="exportContactNo" type="text" placeholder="Export Contact No" class="form-control input-md">
                                            </div>

                                            <label class="col-md-1 " for="drawbackBankAccount">Drawback Bank Account</label>
                                            <div class="col-md-3">
                                                <input id="drawbackBankAccount" name="drawbackBankAccount" type="text" placeholder="Drawback Bank Account" class="form-control input-md">
                                            </div>
