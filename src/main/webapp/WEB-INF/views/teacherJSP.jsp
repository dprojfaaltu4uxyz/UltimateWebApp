...
<html lang="en">
  ...
  <script type="text/javascript" src="<c:url value='/static/assets/fuelux/js/spinner.min.js' />"></script>
  <script type="text/javascript" src="<c:url value='/static/assets/bootstrap-fileupload/bootstrap-fileupload.js' />"></script>
  <script type="text/javascript" src="<c:url value='/static/assets/bootstrap-wysihtml5/wysihtml5-0.3.0.js' />"></script>
  <script type="text/javascript" src="<c:url value='/static/assets/bootstrap-wysihtml5/bootstrap-wysihtml5.js' />"></script>
  <script type="text/javascript" src="<c:url value='/static/assets/bootstrap-datepicker/js/bootstrap-datepicker.js' />"></script>
  <script type="text/javascript" src="<c:url value='/static/assets/bootstrap-datetimepicker/js/bootstrap-datetimepicker.js' />"></script>
  <script type="text/javascript" src="<c:url value='/static/assets/bootstrap-daterangepicker/moment.min.js' />"></script>
  <script type="text/javascript" src="<c:url value='/static/assets/bootstrap-daterangepicker/daterangepicker.js' />"></script>
  <script type="text/javascript" src="<c:url value='/static/assets/bootstrap-colorpicker/js/bootstrap-colorpicker.js' />"></script>
  ...
  <script type="text/javascript" src="<c:url value='/static/assets/jquery-multi-select/js/jquery.quicksearch.js' />"></script>

  <!--select2-->
  <script type="text/javascript" src="<c:url value='/static/assets/select2/js/select2.min.js' />"></script>

  <!--summernote-->
  <script src="<c:url value='/static/assets/summernote/dist/summernote.min.js' />"></script>
