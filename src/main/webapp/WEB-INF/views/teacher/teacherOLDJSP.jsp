...
<link rel="stylesheet"
	href="<c:url value='/static/css/bootstrap-datepicker3.css'/>">
</head>
...
<body class="">
									...
									<form:form method="POST" modelAttribute="teacher"
										...
										<fieldset>
											...
											<div class="form-group">
												...
												<div class="col-md-10">
													<form:input type="text" placeholder="MM/DD/YYY" path="jod"
														id="jod" class="form-control " />
													<div class="has-error">
	...
	<script type="text/javascript"
		src="<c:url value='static/js/bootstrap-datepicker.min.js' />"></script>
