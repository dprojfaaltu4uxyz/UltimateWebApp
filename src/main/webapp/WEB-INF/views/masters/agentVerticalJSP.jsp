			...
			<section class="wrapper site-min-height">
				...
				<section class="panel">
					<header class="panel-heading">
						Agent Master Form <span style="float: right"><a
							href="${pageContext.request.contextPath}/agentlist">Go To
								Agent List</a></span>
					</header>
					<div class="panel-body">
						<div class="form">
							<form:form method="POST" modelAttribute="agent"
								cssClass="cmxform form-horizontal tasi-form" id="agentForm">
								<form:input type="hidden" path="agentId" id="id" />
								<div class="form-group ">
									<label for="agentName" class="control-label col-lg-2">Agent
										Name</label>
									<div class="col-lg-6">
										<form:input class="form-control" id="agentName"
											name="agentName" type="text" path="agentName" />
									</div>
									<div class="has-error">
								...
								<div class="form-group ">
									<label for="agentCode" class="control-label col-lg-2">Agent
										Code</label>
									<div class="col-lg-6">
										<form:input class="form-control" id="agentCode"
											name="agentCode" type="text" path="agentCode" />
									</div>
									<div class="has-error">
										<form:errors path="agentName" class="help-inline" />
									</div>
								...
								<div class="form-group ">
									...
									<div class="col-lg-6">
										<form:select path="port" id="port" multiple="false"
											class="form-control select2">
											<option value="">Select Port</option>
											<form:options items="${portList}" itemValue="portId"
												itemLabel="portName" />
										</form:select>
										<form:input class="form-control" id="selectedPortId"
											name="selectedPortId" type="hidden" path="selectedPortId" />
									</div>
								...
								<div class="form-group ">
									...
									<div class="col-lg-6">
										<form:input class="form-control" id="telephone"
											name="telephone" type="text" path="telephone" />
									</div>
									<div class="has-error">
								...
								<div class="form-group ">
									...
									<div class="col-lg-6">
										<form:input class="form-control" id="fax" name="fax"
											type="text" path="fax" />
									</div>
									<div class="has-error">
								...
								<div class="form-group ">
									<label for="contactPerson" class="control-label col-lg-2">Contact
										Person</label>
									<div class="col-lg-6">
										<form:input class="form-control" id="contactPerson"
											name="contactPerson" type="text" path="contactPerson" />
									</div>
									<div class="has-error">
								...
								<div class="form-group ">
									<label for="contactNumber" class="control-label col-lg-2">Contact
										Number</label>
									<div class="col-lg-6">
										<form:input class="form-control" id="contactNumber"
											name="contactNumber" type="contactNumber"
											path="contactNumber" />
									</div>
									<div class="has-error">
								...
								<div class="form-group ">
									<label for="agree" class="control-label col-lg-2 col-sm-3">Is
										Active</label>
