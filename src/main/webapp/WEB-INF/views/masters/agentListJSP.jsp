	...
	<section id="container">
		...
		<section id="main-content">
			<section class="wrapper site-min-height">
				<!-- page start-->
				<section class="panel">
					<header class="panel-heading"> Agent Master </header>
						...
						<div class="adv-table editable-table ">
							<div class="clearfix">
								<div class="btn-group">
									...
									<a href="${pageContext.request.contextPath}/newagent"
										class="btn green">Add New Agent</a>
								</div>
									...
									<tbody>
										<c:forEach items="${agents}" var="agent">
											<tr>
												...
												<sec:authorize access="hasRole('ADMIN') or hasRole('DBA')">
													<td><a
														href="<c:url value='/edit-agent-${agent.agentId}' />"
														class="edit">Edit</a></td>
												</sec:authorize>
												<sec:authorize access="hasRole('ADMIN')">
													<td><a
														href="<c:url value='/delete-agent-${agent.agentId}' />"
