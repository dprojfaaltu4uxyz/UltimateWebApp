					...
					<div class="col-lg-12">
						<section class="panel">
							<header class="panel-heading">
								Consignee Master Form <span style="float: right"><a
							...
							<div class="panel-body">
								...
								<form:form method="POST" modelAttribute="consignee"
									cssClass="form-horizontal" id="consigneeForm">
									<form:input type="hidden" path="consigneeId" id="id" />
									<div class="form-group">
										<label for="consigneeName" class="col-md-1">Consignee
											Name</label>
										<div class="col-md-3">
											<form:input class="form-control" id="consigneeName"
												name="consigneeName" type="text" path="consigneeName" />
											<div class="has-error">
												<form:errors path="consigneeName" class="help-inline" />
											</div>
										</div>
										<label for="consigneeCode" class="col-md-1">Consignee
											Code</label>
										<div class="col-md-3">
											<form:input class="form-control" id="consigneeCode"
												name="consigneeCode" type="text" path="consigneeCode" />
											<div class="has-error">
										...
										<div class="col-md-3">
											<form:input class="form-control" id="exporter"
												name="exporter" type="text" path="exporter" />
											<div class="has-error">
									...
									<div class="form-group">
										<label for="addressOne" class="col-md-1">Address Line
											1</label>
										<div class="col-md-3">
											<form:input class="form-control" id="addressOne"
												name="addressOne" type="text" path="addressOne" />
											<div class="has-error">
												<form:errors path="addressOne" class="help-inline" />
											</div>
										</div>
										<label for="addressTwo" class="col-md-1">Address Line
											2</label>
										<div class="col-md-3">
											<form:input class="form-control" id="addressTwo"
												name="consigneeCode" type="text" path="addressTwo" />
											<div class="has-error">
												<form:errors path="addressTwo" class="help-inline" />
											</div>
										</div>
										<label for="addressThree" class="col-md-1">Address
											Line 3</label>
										<div class="col-md-3">
											<form:input class="form-control" id="addressThree"
												name="addressThree" type="text" path="addressThree" />
											<div class="has-error">
									...
									<div class="form-group">
										...
										<div class="col-md-3">
											<form:select path="country" id="country" multiple="false"
												class="form-control select2">
												<option value="">Select Country</option>
												<form:options items="${countryList}" itemValue="countryId"
													itemLabel="countryName" />
											</form:select>
											<form:input class="form-control" id="selectedCountryId"
												name="selectedCountryId" type="hidden"
										...
										<div class="col-md-3">
											<form:select path="city" id="city" multiple="false"
												class="form-control select2">
												<option value="">Select City</option>
												<form:options items="${cityList}" itemValue="cityId"
													itemLabel="cityName" />
											</form:select>
											<form:input class="form-control" id="selectedCityId"
												name="selectedCityId" type="hidden" path="selectedCityId" />
											<div class="has-error">
									...
									<div class="form-group">
										...
										<div class="col-md-3">
											<form:checkbox style="width: 20px"
												class="checkbox form-control" id="buyer" name="buyer"
												path="buyer" value="0" />
											<div class="has-error">
												<form:errors path="active" class="help-inline" />
											</div>
