                      ...
                      <section class="panel">
                          <header class="panel-heading">
                              Party/Account Master
                               <span style="float: right"><a href="${pageContext.request.contextPath}/partylist">Go To Party List</a></span>
                          </header>
                          ...
                          <div class="panel-body">
                              ...
                              <form:input type="hidden" path="partyId" id="id"/>
                                  <!-- Select Basic -->
								...
								<div class="form-group">
								  ...
								  <label class="col-md-1 label_check" for="deactivate">Deactivate</label>
								    ...
								    <c:if test="${party.partyId ne 0}">
										<label class="col-md-1 " for="textinput">Party Code</label>  
								  		<div class="col-md-3">
								  			<form:input id="partyCode" name="partyCode" type="text" placeholder="placeholder" readonly="true" class="form-control input-md" path="partyCode"/>
								  		</div>								    	
								    </c:if>
								 </div>
								<div class="stepy-tab">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <form:input id="certificateDate" name="certificateDate" type="certificateDate" placeholder="Certificate Date" class="form-control input-md certificateDate" path="certificateDate"/>
                                      <span class="help-block">Select date</span>
                                      <div class="has-error">
																<form:errors path="certificateDate" class="help-inline" />
															</div>	
                                         
			                         </div>
                                    <label class="col-md-1 " for="validUptoDate">Valid Upto Date</label>  
                                    <div class="col-md-3">
                                         <form:input id="validUptoDate" name="validUptoDate" type="validUptoDate" placeholder="Valid Upto Date" class="form-control input-md validUptoDate" path="validUptoDate"/> 
                                      <span class="help-block">Select date</span>
                                       <div class="has-error">
																<form:errors path="validUptoDate" class="help-inline" />
															</div>	
                                    </div>
                                </div>
