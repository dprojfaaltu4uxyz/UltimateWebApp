							...
							<div class="panel-body">
								<div class=" form">
									<form class="cmxform form-horizontal tasi-form"
										...
										<div class="form-group ">
											<label for="cname" class="control-label col-lg-2">Agent
												Name (required)</label>
											<div class="col-lg-6">
										...
										<div class="form-group ">
											<label for="agentCode" class="control-label col-lg-2">Agent
												Code (optional)</label>
											<div class="col-lg-6">
												<input class="form-control " id="agentCode" type="agentCode"
													name="agentCode" />
											</div>
										</div>
										<div class="form-group ">
											...
											<div class="col-lg-6">
												<input class="form-control " id="contactPerson"
													type="contactPerson" name="contactPerson" />
											</div>
										</div>
										<div class="form-group ">
											...
											<div class="col-lg-6">
												<input class="form-control " id="contactNumber"
													type="contactNumber" name="contactNumber" />
											</div>
										</div>
										<div class="form-group ">
											<label for="telephone" class="control-label col-lg-2">Telephone
												(optional)</label>
											<div class="col-lg-6">
												<input class="form-control " id="telephone" type="telephone"
													name="telephone" />
											</div>
										</div>
										<div class="form-group ">
											<label for="fax" class="control-label col-lg-2">Fax
												(optional)</label>
											<div class="col-lg-6">
										...
										<div class="form-group ">
											<label for="activeStatus"
												class="control-label col-lg-2 col-sm-3">Active
												Status</label>
											<div class="col-lg-10 col-sm-9">
												<input type="checkbox" style="width: 20px"
													class="checkbox form-control" id="activeStatus"
													name="activeStatus" />
											</div>
										</div>
										<div class="form-group">
											<label for="agentType"
												class="control-label col-lg-2 col-sm-3">Agent Type</label>
											<div class="col-lg-10 col-sm-9">
												<input type="radio" class="checkbox form-control"
													name="agentType" id="agentType" value="swl" checked /> SWL
												Agent <input type="radio" class="checkbox form-control"
													name="agentType" id="agentType" value="coloader" />
												Co-Loader Agent
											</div>
										</div>
