...
<body class="mega-nav">
					...
					<div class="col-lg-12">
						<section class="panel">
							<header class="panel-heading">
								State Master Form <span style="float: right"><a
							...
							<div class="panel-body">
								...
								<form:form method="POST" modelAttribute="state"
									cssClass="form-horizontal" id="stateForm">
									<form:input type="hidden" path="stateId" id="id" />
									<div class="form-group">
										<label for="stateName" class="col-md-1">State Name</label>
										<div class="col-md-3">
											<form:input class="form-control" id="stateName"
												name="stateName" type="text" path="stateName" />
											<div class="has-error">
												<form:errors path="stateName" class="help-inline" />
											</div>
										</div>
										<label for="stateCode" class="col-md-1">State Code</label>
										<div class="col-md-3">
											<form:input class="form-control" id="stateCode"
												name="stateCode" type="text" path="stateCode" />
											<div class="has-error">
	...
	<!--script for this page-->
	<script src="<c:url value='/static/js/masters/state.js'/>"></script>
