                    ...
                    <div class="col-lg-12">
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                 ...
                                 <form:form method="POST" modelAttribute="state" cssClass="form-horizontal" id="stateForm">
                                 <form:input type="hidden" path="stateId" id="id"/>
                                    <div class="form-group">
                                       <label for="stateName" class="col-md-1">State Name</label>
                                        <div class="col-md-3">
                                             <form:input class="form-control" id="stateName" name="stateName" type="text" path="stateName" />
                                            <div class="has-error">
                                        ...
                                        <div class="col-md-3">
                                          <form:input class="form-control" id="stateCode" name="stateCode" type="text" path="stateCode" />
                                           <div class="has-error">
