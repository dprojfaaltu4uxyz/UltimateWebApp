                            ...
                            <div class="panel-body">
                                 ...
                                 <form:form method="POST" modelAttribute="jobcard" cssClass="form-horizontal" id="default">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <form:input id="mode" name="mode" type="text" placeholder="Mode" class="form-control input-md" path="mode"/>
                                        </div>
                                        <label class="col-md-1 " for="port">Port (*)</label>
                                        <div class="col-md-3">
                                            <form:input id="port" name="port" type="text" placeholder="Port" class="form-control input-md" path="port"/>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <form:input id="date" name="date" type="text" placeholder="Date" class="form-control input-md date" path="date"/>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-7">
                                            <form:textarea class="form-control" id="reference" name="reference" path="reference"></form:textarea>
                                        </div>
                                        <label class="col-md-1 " for="epzIcdCode">EPZ/ICD Code (*)</label>
                                        <div class="col-md-3">
                                            <form:input id="epzIcdCode" name="epzIcdCode" type="text" placeholder="EPZ/ICD Code" class="form-control input-md" path="epzIcdCode"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-1 " for="rbiWaiverNo">RBI Waiver No</label>
                                        <div class="col-md-3">
                                            <form:input id="rbiWaiverNo" name="rbiWaiverNo" type="text" placeholder="RBI Waiver No" class="form-control input-md" path="rbiWaiverNo"/>
                                        </div>
                                        <label class="col-md-1 " for="rbiWaiverDate">RBI Waiver Date</label>
                                        <div class="col-md-3">
                                            <form:input id="rbiWaiverDate" name="rbiWaiverDate" type="text" placeholder="RBI Waiver Date" class="form-control input-md rbiWaiverDate" path="rbiWaiverDate"/>
                                        </div>
                                        <label class="col-md-1 " for="purposeOfTransfer">Purpose Of Transfer (SEZ)</label>
                                        <div class="col-md-3">
                                            <form:input id="purposeOfTransfer" name="purposeOfTransfer" type="text" placeholder="Purpose Of Transfer" class="form-control input-md" path="purposeOfTransfer"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-1 " for="portmasterByPortLoadingId">Port Of Loading</label>
                                        <div class="col-md-7">
                                            <form:input id="portmasterByPortLoadingId" name="portmasterByPortLoadingId" type="text" placeholder="Port Of Loading" class="form-control input-md" path="portmasterByPortLoadingId"/>
                                        </div>
                                        <label class="col-md-1 " for="modeOfRealization">Mode Of Realization (SEZ)</label>
                                        <div class="col-md-3">
                                            <form:input id="modeOfRealization" name="modeOfRealization" type="text" placeholder="Mode Of Realization" class="form-control input-md" path="modeOfRealization"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-1 " for="terminal">Terminal</label>
                                        <div class="col-md-5">
                                            <form:input id="terminal" name="terminal" type="text" placeholder="Terminal" class="form-control input-md" path="terminal"/>
                                        </div>
                                        <label class="col-md-1 " for="portmasterByPortDischargeId">Port Of Discharge</label>
                                        <div class="col-md-5">
                                            <form:input id="portmasterByPortDischargeId" name="portmasterByPortDischargeId" type="text" placeholder="Port Of Discharge" class="form-control input-md" path="portmasterByPortDischargeId"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-1 " for="vessel">Vessel</label>
                                        <div class="col-md-3">
                                            <form:input id="vessel" name="vessel" type="text" placeholder="Vessel" class="form-control input-md" path="vessel"/>
                                        </div>
                                        <label class="col-md-1 " for="voyNo">Voy No</label>
                                        <div class="col-md-3">
                                            <form:input id="voyNo" name="voyNo" type="text" placeholder="Voy No" class="form-control input-md" path="voyNo"/>
                                        </div>
                                        <label class="col-md-1 " for="viaNo">VIA No</label>
                                        <div class="col-md-3">
                                            <form:input id="viaNo" name="viaNo" type="text" placeholder="VIA No" class="form-control input-md" path="viaNo"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-1 " for="remark">Remark</label>
                                        <div class="col-md-11">
                                            <form:input id="remark" name="remark" type="text" placeholder="Remark" class="form-control input-md" path="remark"/>
                                        </div>
                                    </div>
                                    <div class="stepy-tab">
