					...
					<div class="col-lg-12">
						<section class="panel">
							...
							<div class="panel-body">
								...
								<form:form method="POST" modelAttribute="airagent"
									cssClass="form-horizontal" id="agentForm">
									...
									<div class="form-group">
										...
										<label for="contactPerson" class="col-md-1">Contact
											Person</label>
										<div class="col-md-3">
										...
										<label for="contactNumber" class="col-md-1">Contact
											Number</label>
										<div class="col-md-3">
