          ...
          <section class="wrapper site-min-height">
              ...
              <section class="panel">
                          <header class="panel-heading">
                             Job Card Form
                             <span style="float: right"><a href="${pageContext.request.contextPath}/jobcardlist">Go To Agent List</a></span>
                          </header>
                              ...
                              <div class="form">
                                  <form:form method="POST" modelAttribute="agent" cssClass="cmxform form-horizontal tasi-form" id="agentForm">
                                      ...
                                      <div class="form-group ">
                                          <label for="activityName" class="control-label col-lg-2">Activity Name</label>
                                          <div class="col-lg-6">
                                              <form:input class="form-control" id="activityName" name="activityName" type="text" path="activityName" />
                                          </div>
                                          <div class="has-error">
                                      ...
                                      <div class="form-group ">
                                          <label for="bookingId" class="control-label col-lg-2">Booking Id</label>
                                          <div class="col-lg-6">
                                       ...
                                       <div class="form-group ">
                                          <label for="bookingDate" class="control-label col-lg-2">Booking Date</label>
                                          <div class="col-lg-6">
                                              <form:input class="form-control" id="bookingId" name="bookingId" type="text" path="bookingId" />
                                          </div>
                                          <div class="has-error">
                                      ...
                                      <div class="form-group">
		                                  ...
		                                  <div class="col-md-3 col-xs-11">
		                                      ...
		                                      <div data-date-viewmode="years" data-date-format="dd-mm-yyyy" data-date=""  class="input-append date dpYears">
		                                          <form:input class="form-control" id="bookingDate" name="bookingDate" type="text" path="bookingDate" readonly="" />
