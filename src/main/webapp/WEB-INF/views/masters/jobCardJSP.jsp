							...
							<div class="panel-body">
								...
								<form:form method="POST" modelAttribute="jobcard"
									...
									<div class="form-group">
										<label class="col-md-1 " for="activityName">Activity
											Name (*)</label>
										<div class="col-md-3">
											<form:input id="activityName" name="activityName" type="text"
												placeholder="Activity Name" class="form-control input-md"
												path="mode" />
											<div class="has-error">
												<form:errors path="activityName" class="help-inline" />
											</div>
										</div>
										<label class="col-md-1 " for="bookingId">Booking Id
											(*)</label>
										<div class="col-md-3">
											<form:input class="form-control" id="bookingId"
												name="bookingId" type="text" path="bookingId" />
											<div class="has-error">
									...
									<!-- Text input-->
									<div class="form-group">
										<label class="col-md-1 " for="expectedShipmentDate">Expected
											Shipment Date</label>
										<div class="col-md-3">
											<div data-date-viewmode="years" data-date-format="dd-mm-yyyy"
												data-date=""
												class="input-append date dpYears expectedShipmentDate">
												<form:input class="form-control" id="expectedShipmentDate"
													name="expectedShipmentDate" type="text"
													path="expectedShipmentDate" readonly="" />
									...
									<div class="form-group">
										...
										<div class="col-md-3">
											<div data-date-viewmode="years" data-date-format="dd-mm-yyyy"
												data-date="" class="input-append date dpYears bookingDate">
												<form:input class="form-control" id="bookingDate" size="16"
													name="bookingDate" type="text" path="bookingDate"
													readonly="" />
												<span class="input-group-btn add-on">
													<button class="btn btn-danger" type="button">
														<i class="fa fa-calendar"></i>
										...
										<label class="col-md-1" style="padding-left: 20px"
											for="portmasterByPortLoadingId">Port of Loading (*)</label>
										<div class="col-md-3">
											<form:select path="portmasterByPortLoadingId"
												id="portmasterByPortLoadingId" multiple="false"
												class="form-control select2">
												<option value="">Select Port of Loading</option>
												<form:options items="${portLoadingList}" itemValue="portId"
													itemLabel="portName" />
											</form:select>
											<form:input class="form-control" id="selectedPortLoadingId"
												name="selectedPortLoadingId" type="hidden"
												path="selectedPortLoadingId" />
											<div class="has-error">
												<form:errors path="portmasterByPortLoadingId"
													class="help-inline" />
											</div>
										</div>
										<label class="col-md-1 " for="portmasterByPortDischargeId">Port
											of Discharge (*)</label>
										<div class="col-md-3">
											<form:select path="portmasterByPortDischargeId"
												id="portmasterByPortDischargeId" multiple="false"
												class="form-control select2">
												<option value="">Select Port of Discharge</option>
												<form:options items="${portDischargeList}"
													itemValue="portId" itemLabel="portName" />
											</form:select>
											<form:input class="form-control" id="selectedPortDischargeId"
												name="selectedPortDischargeId" type="hidden"
												path="selectedPortDischargeId" />
											<div class="has-error">
												<form:errors path="portmasterByPortDischargeId"
													class="help-inline" />
											</div>
										</div>
									...
									<div class="form-group">
										<label class="col-md-1 " for="portOfOriginId">Port of
											Origin</label>
										<div class="col-md-3">
											<form:select path="portOfOriginId" id="portOfOriginId"
												...
												<form:options items="${portOriginList}" itemValue="portId"
													itemLabel="portName" />
											</form:select>
											<form:input class="form-control" id="selectedPortOriginId"
												name="selectedPortOriginId" type="hidden"
												path="selectedPortOriginId" />
											<div class="has-error">
										...
										<div class="col-md-3">
											<form:select path="customer" id="customer" multiple="false"
												class="form-control select2">
												<option value="">Select Customer</option>
												<form:options items="${customerList}" itemValue="customerId"
													itemLabel="customerName" />
											</form:select>
											<form:input class="form-control" id="selectedCustomerId"
												name="selectedCustomerId" type="hidden"
										...
										<div class="col-md-3">
											<form:select path="consignee" id="consignee" multiple="false"
												class="form-control select2">
												<option value="">Select Consignee</option>
												<form:options items="${consigneeList}"
													itemValue="consigneeId" itemLabel="name" />
											</form:select>
											<form:input class="form-control" id="selectedConsigneeId"
												name="selectedConsigneeId" type="hidden"
												path="selectedConsigneeId" />
											<div class="has-error">
									...
									<div class="form-group">
										...
										<div class="col-md-3">
											<form:select path="currency" id="currency" multiple="false"
												class="form-control currency">
												<option value="">Select Currency</option>

											</form:select>
											<form:input class="form-control" id="selectedCurrencyId"
												name="selectedCurrencyId" type="hidden"
										...
										<div class="col-md-3">
											<form:select path="containerType" id="containerType"
												...
												<form:options items="${containerTypeList}"
													itemValue="containerTypeId" itemLabel="containerTypeName" />
											</form:select>
											<form:input class="form-control" id="selectedContainerTypeId"
												name="selectedContainerTypeId" type="hidden"
												path="selectedContainerTypeId" />
											<div class="has-error">
										...
										<div class="col-md-3">
											<form:select path="cargoType" id="cargoType" multiple="false"
												class="form-control select2">
												<option value="">Select CargoType</option>
												<form:options items="${cargoTypeList}"
													itemValue="cargoTypeId" itemLabel="cargoTypeName" />
											</form:select>
											<form:input class="form-control" id="selectedCargoTypeId"
												name="selectedCargoTypeId" type="hidden"
												path="selectedCargoTypeId" />
										</div>
										<div class="has-error">
									...
									<div class="form-group">
										<label class="col-md-1 " for="salesPerson">Sales
											Person</label>
										<div class="col-md-3">
											<form:input class="form-control" id="salesPerson"
												name="salesPerson" type="text" path="salesPerson"
										...
										<div class="col-md-3">
											<form:input class="form-control" id="shipper" name="shipper"
												type="text" path="shipper" />
											<div class="has-error">
									...
									<div class="form-group">
										<label class="col-md-1 " for="shippingLineBookingNo">Shipping
											Line Booking No</label>
										<div class="col-md-3">
											<form:input class="form-control" id="shippingLineBookingNo"
												name="shippingLineBookingNo" type="text"
												path="shippingLineBookingNo" />
											<div class="has-error">
												<form:errors path="shippingLineBookingNo"
													class="help-inline" />
											</div>
										</div>
										<label class="col-md-1 " for="freightTerms">Freight
											Terms</label>
										<div class="col-md-7">
											<form:input class="form-control" id="freightTerms"
												name="freightTerms" type="textarea" path="freightTerms" />
											<div class="has-error">
									...
									<div class="form-group">
										<label class="col-md-1 " for="finalPlaceOfDelivery">Final
											Place Of Delivery</label>
										<div class="col-md-3">
											<form:input class="form-control" id="finalPlaceOfDelivery"
												name="finalPlaceOfDelivery" type="text"
												path="finalPlaceOfDelivery" />
											<div class="has-error">
