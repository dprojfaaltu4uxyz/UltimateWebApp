					...
					<div class="col-lg-12">
						<section class="panel">
							<header class="panel-heading">
								Country Master Form <span style="float: right"><a
									href="${pageContext.request.contextPath}/countrylist">Go To
										City List</a></span>
							</header>
							...
							<div class="panel-body">
								...
								<form:form method="POST" modelAttribute="country"
									cssClass="form-horizontal" id="countryForm">
									<form:input type="hidden" path="stateId" id="id" />
									<div class="form-group">
										<label for="countryName" class="col-md-1">Country Name</label>
										<div class="col-md-3">
											<form:input class="form-control" id="countryName"
												name="countryName" type="text" path="countryName" />
											<div class="has-error">
										...
										<div class="col-md-3">
											<form:input class="form-control" id="countryCode"
												name="countryCode" type="text" path="countryCode" />
											<div class="has-error">
