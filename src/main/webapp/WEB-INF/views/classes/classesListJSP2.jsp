                      ...
                      <div class="adv-table editable-table ">
                          <div class="clearfix">
                              <div class="btn-group">
                                  ...
                                  <a href="${pageContext.request.contextPath}/newclass" class="btn green">Add New Class</a> 
                              </div>
                          ...
                          <table class="table table-striped table-hover table-bordered" id="editable-sample">
                              ...
                              <c:forEach items="${classes}" var="classes">
											<tr>
												...
												<td>${classes.note}</td>
											    <sec:authorize access="hasRole('ADMIN') or hasRole('DBA')">
													<td><a href="<c:url value='/edit-user-${user.ssoId}' />" class="edit">Edit</a></td>
										        </sec:authorize>
										        <sec:authorize access="hasRole('ADMIN')">
													<td><a href="<c:url value='/delete-user-${user.ssoId}' />" class="delete">Delete</a></td>
						        				</sec:authorize>
											</tr>
										</c:forEach>
                              </tbody>
