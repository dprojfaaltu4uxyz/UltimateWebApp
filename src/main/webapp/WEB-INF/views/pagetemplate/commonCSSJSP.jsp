<!-- Bootstrap core CSS -->
    ...
    <link rel="stylesheet" type="text/css" href="<c:url value='/static/assets/bootstrap-fileupload/bootstrap-fileupload.css' />" />
    <link rel="stylesheet" type="text/css" href="<c:url value='/static/assets/bootstrap-wysihtml5/bootstrap-wysihtml5.css' />" />
    <link rel="stylesheet" type="text/css" href="<c:url value='/static/assets/bootstrap-datepicker/css/datepicker.css' />" />
    <link rel="stylesheet" type="text/css" href="<c:url value='/static/assets/bootstrap-timepicker/compiled/timepicker.css' />" />
    ...
    <link rel="stylesheet" type="text/css" href="<c:url value='/static/assets/jquery-multi-select/css/multi-select.css' />" />
    ...
    <!--  summernote -->
    <link href="<c:url value='/static/assets/summernote/dist/summernote.css' />" rel="stylesheet">
