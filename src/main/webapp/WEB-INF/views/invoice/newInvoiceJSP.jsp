									...
									<div class="container">
										...
										<div class="modal fade" id="myModal" role="dialog">
											<div class="modal-dialog"
												style="min-width: 1000px; width: 900px;!important">
												...
												<div class="modal-content">
													...
													<div class="modal-body">
														<div class="row">
															<div id="name" class="col-sm-12"
																style="background-color: lavender;" column="description">
																<label>Description</label>
																<textarea name="desc" id="desc" style="width: 100%"
																	value="">
          </textarea>
															</div>
														</div>
														...
														<div class="row">
															<div id="rate" class="col-sm-3"
																style="background-color: lavender;" column="rate">
																<label>Rate</label> <input type="text" name="rate"
																	style="height: 20px; width: 70px; font-size: 08pt;">
															</div>

															<div id="qty" class="col-sm-3"
																style="background-color: lavender;" column="qty">
																<label>Qauntity</label> <input type="text" name="qty"
																	style="height: 20px; width: 70px; font-size: 08pt;">
															</div>
															<div id="currency" class="col-sm-3"
																style="background-color: lavender;" column="currency">
																<label>Currency</label> <input type="text"
																	name="currency"
																	style="height: 20px; width: 70px; font-size: 08pt;">
															</div>
															<div id="exRate" class="col-sm-3"
																style="background-color: lavender;" column="exRate">
																<label>EX-Rate</label> <input type="text" name="exRate"
																	style="height: 20px; width: 70px; font-size: 08pt;">
															</div>
														</div>
														<div class="row">
															<div id="rateXqty" class="col-sm-4"
																style="background-color: lavender;" column="rateXqty">
																<label>Rate X Qauntity</label> <input type="text"
																	name="rateXqty"
																	style="height: 20px; width: 70px; font-size: 08pt;">
															</div>

															<div id="amount" class="col-sm-4"
																style="background-color: lavender;" column="amount">
													...
													<div class="modal-footer" style="padding: 8px;">
														<button id="addBttn" type="button" class="btn btn-default"
															onclick="addRows();">ADD Row</button>
														<button id="editBttn" type="button"
															class="btn btn-default" onclick="editRows();">Edit
															Row</button>
