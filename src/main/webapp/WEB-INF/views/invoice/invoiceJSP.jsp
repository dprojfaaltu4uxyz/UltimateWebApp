...
<body class="mega-nav">
						...
						<section class="panel">
							...
							<div class="panel-body">
								...
								<form class="form-horizontal" id="default">
									...
									<div class="form-group">
										<label class="col-md-1 " for="freight">Packaging and
											Misc </label>
										<div class="col-md-3">
	...
	function refreshData(){
		...
		$("input[name=exRate]").val("");
		$("input[name=rateXqty]").val("");
		$("input[name=amount]").val("");
		$("input[name=date]").val("");
		$("input[name=grossWeight]").val(""); 
		$("input[name=netUnit]").val(""); 
		$("input[name=goodsValue]").val(""); 
		$("input[name=natureOfContract]").val(""); 
		$("input[name=freight]").val(""); 
		$("input[name=unit]").val(""); 
		$("input[name=actualFreight]").val(""); 
		$("input[name=insurance]").val(""); 
		$("input[name=insuranceUnit]").val(""); 
		$("input[name=actualInsurance]").val(""); 
		$("input[name=packagingAndMisc]").val(""); 
		$("input[name=pmUnit]").val(""); 
		$("#actualPM").val(""); 
		$("input[name=otherCharges]").val(""); 
		$("input[name=otherUnit]").val(""); 
		$("input[name=fobValue]").val(""); 
		$("input[name=pmvRate]").val(""); 
		$("input[name=pmvUnit]").val(""); 
		$("input[name=pmvValue]").val("");	
	...
	function editData(rowNo){
		...
		$("input[name=date]").val(itemBean.date);
		$("input[name=grossWeight]").val(itemBean.grossWeight); 
		$("input[name=netUnit]").val(itemBean.netUnit); 
		$("input[name=goodsValue]").val(itemBean.goodsValue); 
		$("input[name=natureOfContract]").val(itemBean.natureOfContract); 
		$("input[name=freight]").val(itemBean.freight); 
		$("input[name=unit]").val(itemBean.unit); 
		$("input[name=actualFreight]").val(itemBean.actualFreight); 
		$("input[name=insurance]").val(itemBean.insurance); 
		$("input[name=insuranceUnit]").val(itemBean.insuranceUnit); 
		$("input[name=actualInsurance]").val(itemBean.actualInsurance); 
		$("input[name=packagingAndMisc]").val(itemBean.packagingAndMisc); 
		$("input[name=pmUnit]").val(itemBean.pmUnit); 
		$("#actualPM").val(itemBean.actualPM); 
		$("input[name=otherCharges]").val(itemBean.otherCharges); 
		$("input[name=otherUnit]").val(itemBean.otherUnit); 
		$("input[name=fobValue]").val(itemBean.fobValue); 
		$("input[name=pmvRate]").val(itemBean.pmvRate); 
		$("input[name=pmvUnit]").val(itemBean.pmvUnit); 
		$("input[name=pmvValue]").val(itemBean.pmvValue);	
		$('#editBttn').show();		
