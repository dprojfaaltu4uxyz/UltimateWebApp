...
Consignee.validation = function(){
    ...
    $().ready(function() {
    	...
    	$("#country").val($("#selectedCountryId").val());
    	$("#country").select2();
        ...
        $("#consigneeForm").validate({
            ...
            messages: {
            	consigneeName: "Please enter your consigneeName",
            	consigneeCode: "Please enter your consigneeCode",
            	port: {
