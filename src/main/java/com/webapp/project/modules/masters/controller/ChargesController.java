...
//	ChargesService chargesService;
	 ...
	 */
	@RequestMapping(value = {"/chargeslist" }, method = RequestMethod.GET)
	public String listUsers(ModelMap model) {

//		List<Charge> charges = chargesService.findAllCharges();
//		model.addAttribute("charges", charges);
	...
	@RequestMapping(value = {"/newcharges" }, method = RequestMethod.GET)
	public String loadCharges(ModelMap model) {
		model.addAttribute("loggedinuser", getPrincipal());
		return "masters/chargesJSP";
	}
	...
	@RequestMapping(value={"/newcharges"},method = RequestMethod.POST)
