...
//		model.addAttribute("loggedinuser", getPrincipal());
	...
	@RequestMapping(value = {"/newservicetaxcode" }, method = RequestMethod.GET)
	public String loadServiceTax(ModelMap model) {
		model.addAttribute("loggedinuser", getPrincipal());
		return "masters/serviceTaxJSP";
	}
	...
	@RequestMapping(value={"/newservicetaxcode"},method = RequestMethod.POST)
