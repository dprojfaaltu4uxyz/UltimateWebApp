...
public class CarrierController {
	...
	@RequestMapping(value = {"/newcarrier" }, method = RequestMethod.GET)
	public String loadCarrier(ModelMap model) {
		model.addAttribute("loggedinuser", getPrincipal());
		return "masters/carrierJSP";
	}
	...
	@RequestMapping(value={"/newcarrier"},method = RequestMethod.POST)
