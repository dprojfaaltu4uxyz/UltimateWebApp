...
public class Invoiceold implements java.io.Serializable {
	...
	public Invoiceold(int schoolyearId, int classesId, int studentId, String feetype, double amount, double discount,
